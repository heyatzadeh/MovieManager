...
{
    std::string input = R"({"id":284052,"imdb_id":"tt1211837","overview":"The movie's plot","title":"a movie","runtime":115})";

    TheMovieDbDataFactory factory;

    auto result = factory.CreateFromJson(input);

    ASSERT_THAT(*result, MovieDataEq("tt1211837", "a movie", "The movie's plot", 115));
}
